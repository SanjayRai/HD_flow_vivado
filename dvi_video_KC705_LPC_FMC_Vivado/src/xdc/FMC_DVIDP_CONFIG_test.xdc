...
set_property IOB TRUE [get_ports fmc_dvidp_dvii_blue[*]]
set_property IOB TRUE [get_ports fmc_dvidp_dvii_green[*]]
set_property IOB TRUE [get_ports fmc_dvidp_dvii_red[*]]
set_property IOB TRUE [get_ports fmc_dvidp_dvio_data[*]]
set_property IOB TRUE [get_ports fmc_dvidp_dvii_de]
set_property IOB TRUE [get_ports fmc_dvidp_dvii_hsync]
set_property IOB TRUE [get_ports fmc_dvidp_dvii_vsync]


set_property HD.PARTITION true [get_cells U_PR_A]
...
set_property EXCLUDE_PLACEMENT true [get_pblocks pblock_U_PR_A]
...
set_property HD.PARTPIN_RANGE {SLICE_X36Y50:SLICE_X37Y99} [get_pins U_PR_A/*]

set_property HD.PARTITION true [get_cells U_PR_B]
...
set_property EXCLUDE_PLACEMENT true [get_pblocks pblock_U_PR_B]
...
set_property HD.PARTPIN_RANGE {SLICE_X36Y0:SLICE_X37Y49} [get_pins U_PR_B/*]
